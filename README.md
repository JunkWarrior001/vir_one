...
![Image text](https://github.com/JunkWarrior001/vir_one/blob/master/virus_chafen2.png)
 ...
 ![Image text](https://github.com/JunkWarrior001/vir_one/blob/master/virus_data_geli3.png)
      ...
      上图中，图一是一种特殊情况，如果一片区域的第一个感染者能够得到迅速的隔离，则这片区域完全不会出现感染者，二，三图则是在初始感染者已经在第一个单位时间传染他人后，病毒扩散的情况，可以看到，病毒扩散的情况依然得到了极大的遏制，只有当前时刻新出现的感染者能够出现在区域中，而其他人员都得到了很好的隔离，由于传染源的大量减少，区域内的病毒携带者虽然没有对其采取措施，但还是远远少于不加控制的情况。
